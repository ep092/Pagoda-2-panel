...
for version in ["2", "2B"]:
	...
	def pcb1(pol):
		...
		shapes += mbpcb.make_text("silk-top", "fonts/Salsa.ttf", "Pagoda-" + version, fontsize1,
				0.0, 3.5, align="center", valign="center", spacing=0.05)
		shapes += mbpcb.make_text("silk-top", "fonts/Salsa.ttf", "Toni B.", 3,
				0.0, -2.5, align="center", valign="center", spacing=0.05)
		shapes += mbpcb.make_text("silk-top", "fonts/Salsa.ttf", "Designed by", 1.2,
				0.0, -6.0, align="center", valign="center", spacing=0.05)
		shapes += mbpcb.make_text("silk-top", "fonts/Salsa.ttf", "Maarten", 1.2,
				0.0, -7.0, align="center", valign="center", spacing=0.05)
		shapes += mbpcb.make_text("silk-top", "fonts/Salsa.ttf", "Baert", 1.2,
